# Prompt — 1DS "oral healthcare" -> HGML
...
You receive marketplace product listings from the 1DS category **oral healthcare**.
...
- `ORAL CARE` / `BOTANIQUE TOOTHPASTE`
...
**Note.** This category has a hand-audited bespoke script, `categories/oral_healthcare.py`, which is more accurate than these rules alone. Use this prompt for the LLM route; use the script for the deterministic route.
