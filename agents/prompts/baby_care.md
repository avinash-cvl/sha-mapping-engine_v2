...
You receive marketplace product listings from the 1DS category **baby care**.
Assign each to exactly one HGML category / sub-category pair from the ALLOWED
LIST. The list is exhaustive and authoritative.

## Allowed targets

- `BABY CARE - OTHERS` / `BABY FOODS`
- `BABY CARE - OTHERS` / `LAUNDRY`
- `BABY TOILETRIES` / `BABY BATH`
- `BABY TOILETRIES` / `BABY CREAMS`
- `BABY TOILETRIES` / `BABY LOTION`
- `BABY TOILETRIES` / `BABY OILS`
- `BABY TOILETRIES` / `BABY POWDER`
- `BABY TOILETRIES` / `BABY RUB`
- `BABY TOILETRIES` / `BABY SHAMPOOS`
- `BABY TOILETRIES` / `BABY SOAPS`
- `BABY TOILETRIES` / `BABY SUNSCREEN`
- `BABY TOILETRIES` / `BABY TOILETRIES - OTHERS`
- `BABY TOILETRIES` / `BOTANIQUE BABY BATH`
- `BABY TOILETRIES` / `BOTANIQUE BABY LOTION`
- `BABY TOILETRIES` / `BOTANIQUE BABY OILS`
- `BABY TOILETRIES` / `BOTANIQUE BABY SOAPS`
- `BABY TOILETRIES` / `GIFT SET`
- `BABY TOILETRIES` / `KIDS TOOTHPASTE`
- `BABY WIPES` / `BABY WIPES`
- `BABY WIPES` / `BOTANIQUE BABY WIPES`
...
1. **Himalaya product name.** If the title names a Himalaya product, use the
   ...
   - "baby bar with pure cow ghee" -> BABY SOAPS
   - "baby cream" -> BABY CREAMS
   - "baby cream with pure cow ghee" -> BABY CREAMS
   - "baby creams" -> BABY CREAMS
   - "baby derma cream with pure cow ghee" -> BABY CREAMS
   - "baby food rice" -> BABY FOODS
