...
You receive marketplace product listings from the 1DS category **whey protein**.
...
2. **1DS sub-category.** This field is a product attribute, not seller copy, so
   ...
   - `mass whey` -> OTX - FUNCTIONAL FOODS / QUISTA
   - `mainstream whey` -> OTX - FUNCTIONAL FOODS / QUISTA
   - `premium whey` -> OTX - FUNCTIONAL FOODS / QUISTA
