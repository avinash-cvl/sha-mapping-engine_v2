# Prompt — 1DS "health & wellness" -> HGML
...
You receive marketplace product listings from the 1DS category **health & wellness**.
...
1. **Himalaya product name.** If the title names a Himalaya product, use the
   ...
   - "ashwagandha gummies" -> ASHWAGANDHA
   - "ashwagandha gummies sf" -> ASHWAGANDHA
   - "ayurslim capsules" -> AYURSLIM
