...
You receive marketplace product listings from the 1DS category **face care**.
Assign each to exactly one HGML category / sub-category pair from the ALLOWED
LIST. The list is exhaustive and authoritative.

## Allowed targets

- `FACE CARE - OTHERS` / `FACE CARE - OTHERS`
- `FACE CARE - OTHERS` / `KAJAL`
- `FACE CARE - OTHERS` / `MICELLAR WATER`
...
- `FACE MOISTURISERS` / `FACE CREAMS`
- `FACE MOISTURISERS` / `FACE GELS`
- `FACE MOISTURISERS` / `FACE SERUMS`
- `FACE MOISTURISERS` / `PREMIUM CREAMS`
- `FACE MOISTURISERS` / `TREATMENT CREAMS`
- `FACE SERUMS` / `FACE SERUMS`
- `FACE WASH` / `FACE WASH`
- `MENS CARE` / `BEARD OIL`
- `MENS CARE` / `FACE CREAMS`
- `MENS CARE` / `FACE WASH`
- `MENS CARE` / `HAIR CREAMS`
- `MENS CARE` / `HAIR GELS`
- `MENS CARE` / `SHAVING`
...
1. **Himalaya product name.** If the title names a Himalaya product, use the
   ...
   - "abana" -> ABANA
   - "abana tablets" -> ABANA
   - "acne clear cleansing gel" -> FACE WASH
   - "acne clear moisturizing gel" -> FACE GELS
