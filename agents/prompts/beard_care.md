...
You receive marketplace product listings from the 1DS category **beard care**.
...
1. **Himalaya product name.** If the title names a Himalaya product, use the
   ...
   - "beard daily nourishing oil" -> BEARD OIL
   - "beard intense growth oil" -> BEARD OIL
   - "beard oil" -> BEARD OIL
   - "hair gels" -> HAIR GELS
   - "intense oil clear lemon face wash" -> FACE WASH
   - "men anti dandruff styling gel normal hold" -> HAIR GELS
