...
1. **Himalaya product name.** If the title names a Himalaya product, use the
   ...
   - "baby diapers" -> DIAPERS / PANTS
   - "baby pants" -> DIAPERS / PANTS
   - "rash shield baby pants" -> DIAPERS / PANTS
   - "shishu anand diapers" -> DIAPERS / PANTS
   - "shishu anand pants diapers" -> DIAPERS / PANTS
   - "soft dry baby pants" -> DIAPERS / PANTS

2. **1DS sub-category.** This field is a product attribute, not seller copy, so
   it is more reliable than any keyword in the title:
   - `diaper pants` -> BABY DIAPERS / DIAPERS / PANTS
   - `taped diapers` -> BABY DIAPERS / DIAPERS / PANTS
