...
You receive marketplace product listings from the 1DS category **adult diapers**.
...
2. **1DS sub-category.** This field is a product attribute, not seller copy, so
   ...
   - `adult diapers & incontinence` -> OTX - OTHERS / ADULT DIAPERS
