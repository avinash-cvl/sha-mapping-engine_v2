...
You receive marketplace product listings from the 1DS category **mass gainer**.
...
2. **1DS sub-category.** This field is a product attribute, not seller copy, so
   ...
   - `mass and weight gainers` -> OTX - FUNCTIONAL FOODS / QUISTA
