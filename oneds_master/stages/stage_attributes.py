...
_COUNT_PATTERNS = (
    ...
    # below and stays correct, because this pattern requires a unit first.
    #
    ...
    # Measured on live data: 15 source listings and 13 master rows use the
    # size-first form -- "Complete Care 300g (150g x 2)", "Baby Cream 400ml
    # (200ml *2 Pack)".
    re.compile(
